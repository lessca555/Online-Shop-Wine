...
<body>
    ...
    <section class="slider">
        ...
        <div class="content">
            <div class="container">
                <div class="box1">
                    <h1><b><i>The Shalz</i></b></h1>
                    <div class="line"></div>
                    <div class="row mt-4">
                        <h1 class="mb-3">Shalz is A Online shop designed by Christian Samuel Seputra. We try to build our community to make the advance way of Shopping especially in Wine Industry </h1>
                    </div>
                </div>
    ...
    <section class="content-1">
        <div class="container">
            <div class="box-2">
                <h1><b><i>Why Shalz?</i></b></h1>
                <div class="line-2"></div>
                <div class="row mt-3">
                <h1 class="mb-3">Because we are the largest wine online shop that exist, we want and we would.</h1>
                </div>
            </div>
        </div>
    </section>
